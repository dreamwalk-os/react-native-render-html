...
export default class HTML extends PureComponent {
    ...
    parseDOM(dom, props = this.props) {
        ...
        const parser = new htmlparser2.Parser(
            new htmlparser2.DomHandler((_err, dom) => {
                ...
                // RNElements.map(element => {
                //     if (element.children[0].tagName == "a") {
                //         element.wrapper = "View";
                //     }
                // });
    ...
    render() {
        ...
        return customWrapper ? customWrapper(RNNodes) : <View style={this.props.containerStyle || {}}>{RNNodes}</View>;
    }
}
