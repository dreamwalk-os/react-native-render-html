...
export function generateDefaultTextStyles(baseFontSize = BASE_FONT_SIZE) {
    return {
        ...
        em: { fontStyle: "italic" },
        i: { fontStyle: "italic" },
        b: Platform.OS === "android" ? { fontFamily: "Quicksand-Bold", fontWeight: "200" } : { fontWeight: "bold" },
        s: { textDecorationLine: "line-through" },
        strong:
            Platform.OS === "android" ? { fontFamily: "Quicksand-Bold", fontWeight: "200" } : { fontWeight: "bold" },
